...
// CarregarTelaLogin rendereliza a tela de login
func CarregarTelaLogin(w http.ResponseWriter, r *http.Request) {
	cookie, _ := cookies.Ler(r)

	// esse if evita que o usuário autenticado acesse a tela de login
	// é verificado se o token não está vazio, caso não esteja, o usuáro já está logado e não tem porque acessar a tela de login, nesse caso redireciona para a tela /home
	if cookie["token"] != "" {
...
// CarregarPaginaCadastroUsuario carrega a página de cadastro do usuario
...
// CarregarPaginaAtualizacaoPublicacao carrega a página de edição de publicação
...
// CarregarPaginaUsuarios carrega a página com os usuários que atendem o fltro passado
...
// CarregarPerfilUsuarios carrega a página do perfil do usuário que atendem o fltro passado
