...
// NovoRepositorioPublicacoes cria um repositório de publicacoes
func NovoRepositorioPublicacoes(db *sql.DB) *Publicacoes {
	return &Publicacoes{db}
}

// Criar insere uma publicacao no banco
...
// BuscarPublicacoes traz todos as publicações do usuário e de quel ele segue
...
// Atualizar altera uma publicação na base de dados
